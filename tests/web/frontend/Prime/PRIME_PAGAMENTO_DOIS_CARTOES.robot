*** Settings ***
Documentation      FASTSHOP - PRIME DOIS CARTÕES DE CRÉDITO
...
*** Test Cases ***
PRIME - PAGAR COM DOIS CARTÕES DE CRÉDITO 
    [Template]                  PRIME: Pagar com DOIS CARTÕES DE CRÉDITO e copiar o número da order

    [Tags]                      DOIS_CARTOES_DE_CREDITO_PAGO                    PAGAMENTOS_IBM2
...
*** Keywords ***
PRIME: Pagar com DOIS CARTÕES DE CRÉDITO e copiar o número da order
