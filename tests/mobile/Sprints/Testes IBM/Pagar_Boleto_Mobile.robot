*** Settings ***
Documentation      FASTSHOP - BOLETO MOBILE
...                BOLETO MOBILE - Obrigado por comprar na Fast Shop!
...
REGRESSÃO - PAGAR COM BOLETO 
    [Template]                  Regressão: Pagar um Boleto no mobile e copiar o número do codigo de barras

    [Tags]                      MOBILE_BOLETO_PAGO          PAGAMENTOS_IBM_MOBILE               
    #CPF                        #Senha                      #Sku                                                       
    63240518970                 12345678                    AEMQUE2BZABCOB              

         
*** Keywords ***
Regressão: Pagar um Boleto no mobile e copiar o número do codigo de barras
